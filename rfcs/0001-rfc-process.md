...
This RFC defines how activeadmin-graphql design changes are proposed, written, numbered, and advanced.

## Motivation

The GraphQL HTTP path, generated field and mutation names, authorization mapping, and namespace caps are the public contract. Clients encode that schema. Numbered RFCs are the unit for a change that would move the gem version for every GraphQL client. RFC 0002 records why the schema is generated from ActiveAdmin registration.
